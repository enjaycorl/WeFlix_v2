  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        ...
        description={
          genre
            ? `Stream ${genre.name} TV shows free on PirTV. Watch the best ${genre.name.toLowerCase()} series, from binge-worthy dramas to must-watch hits.`
            : 'Stream trending TV shows and series free on PirTV. Discover the most popular, top-rated, and newest shows across all genres.'
        }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.08] shadow-sm">
              <BiTv className="text-brand-500 text-xl" />
            </div>
